...
public class EOS_SingleLobbyManager : MonoBehaviour
{
    ...
    private EOS_Lobby CreateJoinedLobby(EOS_Core eosCore, EOS_SingleLobbyManager singleLobbyManager, string lobbyID)
    {
        _currentLobby = new EOS_Lobby(eosCore, singleLobbyManager, lobbyID, _localUser._localPUID);
    ...
    public class EOS_Lobby
    {
        ...
        public EOS_Lobby(EOS_Core eosCore, EOS_SingleLobbyManager singleLobbyManager, string lobbyID, EOSWrapper.ETC.PUID localPUID)
        {
            _lobbyID = lobbyID;
            ...
            _attribute = new Dictionary<string, Epic.OnlineServices.Lobby.Attribute>();
            _eosCore = eosCore;
            _singleLobbyManager = singleLobbyManager;
            _joined = true;
